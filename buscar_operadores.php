...
// Recuperar los registros de operadores con disponibilidad 1 y 2
$sql = "SELECT o.*, u.correo FROM operadores o
            ...
            <tbody>
                <?php while($row = $result->fetch_assoc()): ?>
                    <tr>
                        ...
                        <td><?php echo htmlspecialchars($row['disponibilidad'] == '1' ? 'En busca de una oportunidad de trabajo' : 'Actualmente laborando, pero buscando una mejor oportunidad'); ?></td>
                        <td>
